...
2. **중요:** 질문(question) 텍스트 안에 (O), (X), 정답, O, X 등을 절대 포함하지 마세요.
3. **난이도 조절:** 너무 뻔한 상식 문제는 피하고, 소상공인들이 자주 헷갈리는 내용이나 오해하기 쉬운 조건을 문제로 내주세요. (목표 정답률 60%)
4. 다만, 너무 지엽적인 숫자(소수점 단위 금리 등)나 날짜를 묻는 건 피해 주세요. 자격 요건이나 제외 대상 등을 다뤄주세요.
5. 질문은 문장형으로 끝내주세요. (예: "~이다.", "~할 수 있다.")
6. 정답이 O인 것과 X인 것을 섞어서 만들어주세요.
7. 설명은 명확하게, 팁은 실용적으로 작성해주세요.
